...
6 | 6/19 | :seedling: **섹션 7. Relation** </br> Relation 개요 </br> 릴레이션 모델 선언하기 </br> 리뷰 등록 구현하기 </br> 리뷰 삭제 구현하기 </br> Join 개요 </br> Join으로 모든 리뷰 리스트 불러오기 </br> 리스트 화면에서 리뷰 개수와 평점 구하기 | `료`
